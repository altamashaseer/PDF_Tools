...
const mergePDF = async (path1, path2) => {
    await merger.add(path1);  //merge all pages. parameter is the path to file and filename.
    await merger.add(path2);  //merge all pages. parameter is the path to file and filename.
